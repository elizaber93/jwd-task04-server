        ...
        for (Sentence sentence : sentences) {
            ...
            for (int i = sentence.getElements().size() - 1; i >= 1; i--) {
                if (sentence.getElements().get(i) instanceof Word){
                    ...
                    if (lastWordIndex == sentence.getElements().size() -1) {
                        sentence.getElements().add(firstword);
                        sentence.getElements().remove(lastWordIndex);
                    } else {
                        sentence.getElements().add(lastWordIndex, firstword);
                        sentence.getElements().remove(lastWordIndex+1);
                    }
